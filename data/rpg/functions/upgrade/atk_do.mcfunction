...
execute if entity @s[nbt={Inventory:[{id:"minecraft:emerald"}]}] run scoreboard players add @s atk 1
...
execute if entity @s[nbt={Inventory:[{id:"minecraft:emerald"}]}] run tellraw @s [{"text":"[Upgrade] ATK +1 applied. Current ATK: ","color":"green"},{"score":{"name":"@s","objective":"atk"},"color":"gold"}]
